...
// log_channel& datastore::create_channel([[maybe_unused]] boost::filesystem::path location) {}

epoch_id_type datastore::last_epoch() { return 0; }

void datastore::switch_epoch([[maybe_unused]] epoch_id_type epoch_id) {}

void datastore::add_persistent_callback([[maybe_unused]] std::function<void(epoch_id_type)> callback) {}

void datastore::switch_safe_snapshot([[maybe_unused]] write_version_type write_version, [[maybe_unused]] bool inclusive) {}

void datastore::add_snapshot_callback([[maybe_unused]] std::function<void(write_version_type)> callback) {}
